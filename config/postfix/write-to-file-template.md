...
sudo apt update && sudo apt install nano -y && \
  ...
  sudo chown nobody:root /var/log/webstackup-email_transport_write-to-file.log && \
  sudo chmod u=rw,g=r,o= /var/log/webstackup-email_transport_write-to-file.log && \
  sudo nano /etc/postfix/master.cf && sudo nano /etc/postfix/main.cf && \
...
wsu_write_to_file_transport unix  -      n       n       -       -       pipe
  flags=F user=nobody argv=/usr/local/turbolab.it/webstackup/script/mail/transport_write-to-file.sh
