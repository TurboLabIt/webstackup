...
sudo apt update && sudo apt install nano -y && \
  ...
  echo "Test from $(hostname) with redirect" | mail -s "Hello, this is $(hostname)! I sent this one to none@none.com, but you should get it nonetheless!" -a FROM:info@my-test-app.com none@none.com && \
