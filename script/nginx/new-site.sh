...
curl -o "${NEW_PROPERTY_DIR}.gitignore" https://raw.githubusercontent.com/ZaneCEO/webdev-gitignore/master/.gitignore

mkdir -p "${NEW_WWW_DIR}script/"

mkdir -p "${NEW_WWW_DIR}backup/"
curl -o "${NEW_WWW_DIR}backup/.gitignore" https://raw.githubusercontent.com/ZaneCEO/webdev-gitignore/master/.gitignore_contents

mkdir -p "${NEW_WWW_DIR}var/log/"
curl -o "${NEW_WWW_DIR}var/log/.gitignore" https://raw.githubusercontent.com/ZaneCEO/webdev-gitignore/master/.gitignore_contents
