...
printHeader "🛡️ Generate black|white list"
rootCheck
...
git -C ${WEBSTACKUP_INSTALL_DIR} add ${WEBSTACKUP_CONFIG_DIR}firewall/autogen_whitelist.txt ${WEBSTACKUP_CONFIG_DIR}firewall/autogen_blacklist.txt
git -C ${WEBSTACKUP_INSTALL_DIR} commit -m"🧱 autogenerated firewall lists update"
