...
function wsuMirrorFromSsh()
{
  ...
  local -a RCLONE_FULL_COMMAND=(rclone sync --sftp-ssh "ssh ${1}@${2}" --create-empty-src-dirs --links --transfers 4 --checkers 8 --log-level ERROR --progress --exclude '*.log' --exclude '*.log.[0-9]*' --exclude '*.partial' ":sftp:${3}" "$4")
