...
function wsuMirrorFromSsh()
{
  ...
  local -a RCLONE_FULL_COMMAND=(rclone sync --sftp-ssh "ssh ${1}@${2}" --create-empty-src-dirs --links --transfers 16 --checkers 32 --log-level ERROR --progress --exclude '*.log' --exclude '*.log.[0-9]*' ":sftp:${3}" "$4")
