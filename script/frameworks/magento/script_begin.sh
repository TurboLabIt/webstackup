...
MAGENTO_CONFIG_DEV_JS_ENABLE_JS_BUNDLING=0
MAGENTO_CONFIG_DEV_JS_MINIFY_FILES=1
MAGENTO_CONFIG_DEV_JS_MOVE_SCRIPT_TO_BOTTOM=0
MAGENTO_CONFIG_DEV_CSS_MERGE_CSS_FILES=1
MAGENTO_CONFIG_DEV_CSS_MINIFY_FILES=1
MAGENTO_CONFIG_DEV_TEMPLATE_MINIFY_HTML=0
