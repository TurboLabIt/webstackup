...
if [ "${WSU_CERT_WILDCARD}" == 0 ]; then
  ...
  WSU_CERT_FILENAME=https-selfsigned-${WSU_MAP_DOMAIN_DEFAULT}.crt

else

  WSU_CERT_COMPLETE_DOMAIN="*.${WSU_MAP_DOMAIN_DEFAULT}"
  WSU_CERT_FILENAME=https-selfsigned-wildcard-${WSU_MAP_DOMAIN_DEFAULT}.crt
...
WSU_CERT_FILE_FULLPATH=${WSU_CERT_PATH}${WSU_CERT_FILENAME}
